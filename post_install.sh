...
mkdir /opt
curl -L https://github.com/paperless-ngx/paperless-ngx/releases/download/v2.2.1/paperless-ngx-v2.2.1.tar.xz --output paperless-ngx-v2.2.1.tar.xz
tar -zxf paperless-ngx-v2.2.1.tar.xz
